...
export declare namespace ILPool {
  export type InitializationStruct = {
    _owner: AddressLike;
    _longToken: AddressLike;
    _shortToken: AddressLike;
    _marginLimit: BigNumberish;
...
export interface LPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LONG_INDEX"
      | "SHORT_INDEX"
  ...
  encodeFunctionData(
    ...
    values: [ILPool.InitializationStruct]
  ): string;
  encodeFunctionData(
...
export interface LPool extends BaseContract {
  connect(runner?: ContractRunner | null): LPool;
  ...
  initialize: TypedContractMethod<
    [initialization: ILPool.InitializationStruct],
    [void],
    "nonpayable"
  >;
